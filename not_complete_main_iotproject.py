...
print("Serial OK")
aio = Client('Kanokkwan','aio_iuKk98Pu3R1C3KddhJIhJ3PiMUIP')
Ardunio_Vibration_Medium = aio.feeds('arduino-vibration-medium')
Ardunio_Vibration_High = aio.feeds('arduino-vib-alt')
Ardunio_Ultrasonic_Close = aio.feeds('arduino-ultrasonic')
Ardunio_Ultrasonic_Medium = aio.feeds('ardunio-ultrasonic-medium')
Ardunio_Frame = aio.feeds('Raspberry_Fire')
